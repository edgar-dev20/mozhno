...
**можно.** поддерживает командную работу с тремя ролями доступа. Каждый пользователь имеет свою учётную запись; приглашения отправляются через веб-панель или REST API.
