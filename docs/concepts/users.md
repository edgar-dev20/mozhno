...
Имя не указывается при приглашении — пользователь задаёт его сам при активации аккаунта.
...
Администратор может просматривать список пользователей, изменять роли и удалять учётные записи через раздел **Пользователи** в веб-панели. Email и имя пользователя неизменяемы — они задаются при активации аккаунта.
