...
Модульная структура **можно**<span class=brand-dot>.</span>: диаграмма модулей, технологический стек, поток оценки флагов и JWT-аутентификация.

## Модульная структура

**можно**<span class=brand-dot>.</span> разделён на четыре Gradle-модуля, образующих строгий граф зависимостей:
