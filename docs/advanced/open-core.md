...
- **Community Edition (CE)** — BSL 1.1. Полнофункциональная система фича-флагов: RELEASE и KILLSWITCH флаги, контекстные правила и сегменты, процентный роллаут, аудит, API-ключи, JWT-аутентификация, REST API, React-панель.
...
| Функция | Community (BSL 1.1) | Enterprise |
|---------|----------------------|------------|
| RELEASE флаги | Да | Да |
