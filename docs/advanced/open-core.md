...
- **Community Edition (CE)** — Apache 2.0. Полнофункциональная система фича-флагов: булевы и мультивариативные флаги, стратегии (Default, Gradual, Scheduled), сегменты, аудит, API-ключи, JWT-аутентификация, REST API, React-панель.
...
| Расширенные стратегии | `strategy.advanced` | A/B-тесты, multivariate, ML-based |
...
| Функция | Community (Apache 2.0) | Enterprise |
|---------|----------------------|------------|
| Булевы флаги | Да | Да |
| Мультивариативные флаги | Да | Да |
| Стратегии (Default, Gradual, Scheduled) | Да | Да |
