...
В этой статье описан полный жизненный цикл фиче-флага в **можно**<span class=brand-dot>.</span>: от создания до архивации, организация флагов по тегам и лучший workflow для команд.

## Жизненный цикл флага

Флаг в **можно**<span class=brand-dot>.</span> имеет два основных состояния:
...
1. На странице флага выберите окружение (Development, Production)
