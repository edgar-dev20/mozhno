...
Переходите к [Быстрому старту](/intro/quick-start) — запустите платформу за 5 минут.
...
- [Работа с флагами](/guide/flags-workflow) — полный цикл: от создания до архивации
