...
const en = {
  ...
  flags: {
    ...
    summaryFlagOff: 'Flag is off — rule does not apply',
    summaryFullTraffic: 'Full traffic — flag active for all users',
    summaryFromBelow: 'of the users below',
    ...
    chipPlaceholder: '+ add...',
    chipEmptyPlaceholder: 'Type a value...',
    chipHintEmpty: 'Enter to add',
    chipHint: 'Enter to add · Backspace to remove last',
    ...
    metrics: {
      ...
      avgPerHour: 'Avg/hr',
      allApps: 'All apps',
      contributorsTitle: 'Contributors · last 48 hours',
      noContributorsTitle: 'SDKs have not sent metrics yet',
      noContributorsDesc:
        'Contributor data appears for SDK requests that send the X-Mozhno-Instance-Id header.',
      filteredEmpty: 'No evaluations for the selected app in the last 48 hours',
      showAll: 'Show all',
    },
  ...
  segments: {
    ...
    errors: {
      ...
      fileTooBig: 'File too large. Maximum size: {{size}}MB',
      conditionRequired: 'Add at least one targeting condition',
    },
  },
  navigation: {
  ...
  integrations: {
    ...
    bodyInvalidJson: 'Invalid JSON — fix it or the request will fail',
  ...
  clientInstances: {
    ...
    activity: 'Activity',
    usageTitle: 'Activations',
    usageCount: '{{used}} of {{total}}',
    usageCountTooltip: 'The app called {{used}} of {{total}} flags in the selected period',
    usageEmpty: 'The app attempted no flag activations in the period (or the SDK does not report metrics)',
    usageLoadError: 'Failed to load activations',
    usageRetry: 'Retry',
    usageWindowLabel: 'Period',
    usageWindowHint: 'Period for activation attempts; limited by metric and instance data retention',
    usageWindow24h: '24 h',
    usageWindow7d: '7 d',
    usageWindow30d: '30 d',
    usageRateTooltip: 'Activated in {{pct}}% of checks',
    usageLowSample: 'not enough data for a reliable rate',
    usageConfigRollout: 'Configured rollout in flag settings',
    filterEmptyTitle: 'Nothing found',
    filterEmptyDescription: 'Adjust filters or the search query',
  },
