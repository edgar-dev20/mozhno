...
function parseWebhookConfig(integration: Integration): {
  url: string;
      ...
      <SidePanel
        ...
        footer={
          <>
            ...
            <GradientButton onClick={handleSave} disabled={saving || !isDirty} loading={saving}>
        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-neutral-950 border border-border rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-ring/50 focus:border-ring transition-all placeholder:text-muted-foreground"
              />
            </div>
          </FormField>
              ...
              {formHeaders.map((h) => (
                <div key={h.id} className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 bg-white dark:bg-neutral-950 border border-border rounded-lg px-3 py-2 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-ring/50 focus:border-ring transition-all placeholder:text-muted-foreground"
                  />
                  <input
                    type="text"
                    value={h.value}
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              rows={7}
              className="w-full bg-white dark:bg-neutral-950 border border-border rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-ring/50 focus:border-ring transition-all placeholder:text-muted-foreground resize-y"
            />
