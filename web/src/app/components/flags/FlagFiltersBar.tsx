            ...
            {tags.map((tg) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg transition-all border ${active ? 'text-primary-foreground dark:brightness-[.85] dark:saturate-[.7]' : 'bg-accent text-muted-foreground hover:bg-accent/80 border-transparent'}`}
                  style={
                    active
              ...
              {uniqueTagValues(selectedTagTypeFilter).map((v) => {
                ...
                return (
                  <button
                    ...
                    className={`inline-flex items-center px-3 py-1.5 text-xs font-semibold rounded-lg transition-all border ${active ? 'text-primary-foreground dark:brightness-[.85] dark:saturate-[.7]' : 'bg-accent text-muted-foreground hover:bg-accent/80 border-transparent'}`}
                    style={
                      active
                        ? {
