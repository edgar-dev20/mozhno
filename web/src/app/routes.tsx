...
const Segments = lazy(() => import("@/app/components/Segments").then(m => ({ default: m.Segments })));
const Strategies = lazy(() => import("@/app/components/Strategies").then(m => ({ default: m.Strategies })));
const ApiKeys = lazy(() => import("@/app/components/ApiKeys").then(m => ({ default: m.ApiKeys })));
const ClientInstances = lazy(() => import("@/app/components/ClientInstances").then(m => ({ default: m.ClientInstances })));
const Constraints = lazy(() => import("@/app/components/Constraints").then(m => ({ default: m.Constraints })));
...
const AuditLog = lazy(() => import("@/app/components/AuditLog").then(m => ({ default: m.AuditLog })));
const Integrations = lazy(() => import("@/app/components/Integrations").then(m => ({ default: m.Integrations })));
