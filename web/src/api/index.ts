...
export type SegmentResponse = { id: number; projectId: number; name: string; description: string; createdAt: string; context: { contextDefinitionId: number; operator: string; contextValues: string }[] };
export type SegmentRequest = { projectId: number; name: string; description?: string; context?: { contextDefinitionId: number; operator: string; contextValues: string }[] };
