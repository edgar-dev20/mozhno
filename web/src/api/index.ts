...
export type FlagResponse = { id: number; projectId: number; name: string; key: string; description: string; flagType: string; createdAt: string; tags: FlagTagValue[]; enabled: boolean; strategyId: number; percentage: number; contextDefinitionId: number; contextValuesJson: string; segmentId: number };
...
export type FlagStrategy = { id: number; flagId: number; environmentId: number; enabled: boolean; percentage: number; contextDefinitionId: number; contextValuesJson: string; segmentId: number; createdAt: string };
export type StrategyRequest = { flagId?: number; environmentId: number; enabled?: boolean; percentage?: number; contextDefinitionId?: number; contextValuesJson?: string; segmentId?: number };
