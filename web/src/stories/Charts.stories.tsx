...
function ChartDemo() {
  return (
    <div className="p-8 space-y-12 max-w-4xl">
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground/40 mb-4">Stacked Bar Chart</h2>
        <div className="rounded-xl bg-card ring-1 ring-border p-5 h-[350px]">
          ...
          />
          <Bar dataKey="false" stackId="a" fill="var(--sparkline-false)" radius={[3, 3, 0, 0]} name="false" />
          <Bar dataKey="true" stackId="a" fill="var(--sparkline-true)" radius={[3, 3, 0, 0]} name="true" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </section>
      ...
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground/40 mb-4">Line Chart</h2>
        <div className="rounded-xl bg-card ring-1 ring-border p-5 h-[350px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={LINE_DATA} margin={{ top: 8, right: 8, bottom: 0, left: 0 }}>
              <CartesianGrid
                ...
                vertical={false}
              />
              <XAxis dataKey="day" tick={{ fontSize: 11, fill: "var(--color-muted-foreground)" }} height={30} />
          ...
          />
              <Line
                ...
                strokeWidth={2}
                dot={{ stroke: "var(--color-brand)", strokeWidth: 2, fill: "var(--color-card)", r: 4 }}
                activeDot={{ r: 6 }}
              />
              <Line
                type="monotone"
                ...
                strokeWidth={2}
                dot={{ stroke: "var(--color-chart-5)", strokeWidth: 2, fill: "var(--color-card)", r: 4 }}
                activeDot={{ r: 6 }}
              />
            </LineChart>
          </ResponsiveContainer>
      ...
      <section>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground/40 mb-4">Chart Colors</h2>
