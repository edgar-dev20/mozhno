...
const seg = (
  ...
  id, projectId: 1, name, description, icon, color, context, createdAt: "2025-01-01T00:00:00Z",
});
...
const ctx = (id: number, name: string, type = "string"): ContextDefinition => ({
  id, projectId: 1, name, key: name, type, createdBy: null, description: "",
  isStrict: false, validValues: [], createdAt: "2025-01-01T00:00:00Z",
});

const CONTEXTS: ContextDefinition[] = [
  ctx(10, "country"), ctx(11, "app_version", "semver"), ctx(12, "plan"),
  ctx(13, "role"), ctx(14, "signup_date", "time"), ctx(15, "email"),
];
