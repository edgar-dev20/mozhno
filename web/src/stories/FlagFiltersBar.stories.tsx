...
function Demo() {
  ...
  return (
    <FlagFiltersBar
      ...
      sortBy={sort}
      onSortByChange={ssort}
      tags={[]}
      selectedTagTypeFilter={tagType}
      onTagTypeFilterChange={stagType}
      selectedTagValueFilter={tagVal}
      onTagValueFilterChange={stagVal}
      uniqueTagValues={() => []}
    />
  );
}
