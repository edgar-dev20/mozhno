...
export const Uppercase: Story = { args: { variant: "primary", uppercase: true, children: "UPPER" } };
export const Solid: Story = { args: { variant: "success", style: "solid", children: "Solid" } };
export const Outline: Story = { args: { variant: "primary", style: "outline", children: "Outline" } };
export const WithIcon: Story = { args: { variant: "success", icon: <span className="w-1.5 h-1.5 rounded-full bg-current" />, children: "With Icon" } };
