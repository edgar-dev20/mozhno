...
const SEMANTIC = [
  ...
  { name: 'accent', label: 'Accent', light: 'bg-accent text-accent-foreground', dark: '' },
  {
    name: 'destructive',
    label: 'Destructive',
    light: 'bg-destructive text-destructive-foreground',
    dark: '',
  },
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Complete color system: semantic tokens (background, foreground, primary, etc.), 7 palette scales (gray, brand, success, warning, danger, info, primary) with 11 steps each (50–950), chart colors, sparkline colors, and disabled state.',
      },
    },
  },
};
