...
**Hue drift:** `hsl(240, 80%, 20%)` and `hsl(240, 80%, 90%)` are not the same perceptual hue. The light variant shifts ~18° toward purple (see [accessibility-contrast.md](accessibility-contrast.md)). OKLCH hue is stable.
