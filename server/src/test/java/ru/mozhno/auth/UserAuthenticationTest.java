...
class UserAuthenticationTest {
    ...
    void shouldContainRoleUserAndSpecificRole() {
        UserAuthentication auth = new UserAuthentication(1, "test@example.com", "Test User", "admin", "active");
    ...
    void shouldHandleViewerRole() {
        UserAuthentication auth = new UserAuthentication(2, "viewer@example.com", "Viewer", "viewer", "active");
    ...
    void shouldHandleEditorRole() {
        UserAuthentication auth = new UserAuthentication(3, "editor@example.com", "Editor", "editor", "active");
    ...
    void shouldHandleDeveloperRole() {
        UserAuthentication auth = new UserAuthentication(4, "dev@example.com", "Developer", "developer", "active");
    ...
    void shouldHandleSuspendedUser() {
        UserAuthentication auth = new UserAuthentication(5, "suspended@example.com", "Suspended", "developer", "suspended");
