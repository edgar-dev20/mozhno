...
class FlagRepositoryTest extends BaseIntegrationTest {
    ...
    void deleteById_shouldRemoveFlag() {
        ...
        flagRepository.deleteById(saved.getId(), saved.getProjectId());
    ...
    void setArchived_shouldSetUnarchivedFlag() {
        ...
        flagRepository.setArchived(saved.getId(), true, null, saved.getProjectId());
        flagRepository.setArchived(saved.getId(), false, null, saved.getProjectId());
    ...
    void findByProjectId_shouldExcludeArchived() {
        ...
        flagRepository.setArchived(saved2.getId(), true, null, saved2.getProjectId());
